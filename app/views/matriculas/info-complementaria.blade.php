...
<div class="tab-content">
  ...
  <div class="tab-pane fade" id="mama">
    ...
    <!-- E-Mail -->
    <div class="form-group col-sm-12">
      {{ Form::label('celM', 'Correo Electronico', array('class' => 'col-sm-2 control-label')) }}
      <div class="col-sm-2">
        {{ Form::Text('celM', null, array('placeholder' => 'Email', 'class' => 'col-sm-2 form-control')) }}
      </div>  
    </div>
  ...
  <br>
    ...
    <!-- Parentesco   -->
    <div class="form-group col-sm-12">
      {{ Form::label('Parent', 'Parentesco', array('class' => 'col-sm-2 control-label')) }}
      <div class="col-sm-2">
        {{ Form::Text('Parent', null, array('placeholder' => 'Parentesco', 'class' => 'col-sm-2 form-control')) }}
      </div>  
    </div>
